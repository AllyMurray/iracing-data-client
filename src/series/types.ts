  ...
  z.object({
    ...
    schedules: z.array(
      z.object({
        ...
        raceWeekCarClassIds: z.array(z.number()),
        raceWeekCars: z.array(
          z.object({
            carId: z.number(),
            carName: z.string(),
    ...
    scoreAsCarclassid: z.optional(z.number()),
    seasonQuarter: z.number(),
    seasonShortName: z.string(),
    seasonYear: z.number(),
  ...
  seasons: z.array(
    z.object({
      ...
      currentWeekSched: z.object({
        ...
        raceLapLimit: z.nullable(z.number()),
        raceTimeLimit: z.nullable(z.number()),
        precipChance: z.optional(z.number()),
        startType: z.string(),
        categoryId: z.number(),
      }),
      distributedMatchmaking: z.boolean(),
      ...
      qualifierMustStartRace: z.boolean(),
      raceWeek: z.number(),
      raceWeekCarClassIds: z.optional(
        z.array(
          z.object({
            raceWeekNum: z.number(),
            carClassIds: z.array(z.number()),
...
const SeriesSeasonSchedule = z.object({
  success: z.boolean(),
  seasonId: z.number(),
  schedules: z.array(
    z.object({
...
const SeriesStatsSeries = z.array(
  z.object({
    seriesId: z.number(),
    seriesName: z.string(),
    seriesShortName: z.string(),
