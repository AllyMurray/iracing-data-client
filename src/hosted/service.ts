...
export class HostedService {
   ...
   */
  async combinedSessions(
    params?: HostedCombinedSessionsParams,
  ): Promise<HostedCombinedSessionsResponse> {
    return this.client.get<HostedCombinedSessionsResponse>(
      'https://members-ng.iracing.com/data/hosted/combined_sessions',
      { params, paramsValidator: combinedSessionsParams, schema: HostedCombinedSessions },
    );
  }
  ...
  async sessions(): Promise<HostedSessionsResponse> {
    return this.client.get<HostedSessionsResponse>(
      'https://members-ng.iracing.com/data/hosted/sessions',
      { schema: HostedSessions },
    );
  }
}
