...
export class MemberService {
  ...
  async awards(params: MemberAwardsParams): Promise<MemberAwardsResponse> {
    return this.client.get<MemberAwardsResponse>("https://members-ng.iracing.com/data/member/awards", { params, schema: MemberAwardsSchema });
  }
  ...
  async awardInstances(params: MemberAwardInstancesParams): Promise<MemberAwardInstancesResponse> {
    return this.client.get<MemberAwardInstancesResponse>("https://members-ng.iracing.com/data/member/award_instances", { params, schema: MemberAwardInstancesSchema });
  }
  ...
  async chartData(params: MemberChartDataParams): Promise<MemberChartDataResponse> {
    return this.client.get<MemberChartDataResponse>("https://members-ng.iracing.com/data/member/chart_data", { params, schema: MemberChartDataSchema });
  }
  ...
  async get(params: MemberGetParams): Promise<MemberGetResponse> {
    return this.client.get<MemberGetResponse>("https://members-ng.iracing.com/data/member/get", { params, schema: MemberGetSchema });
  }
  ...
  async profile(params: MemberProfileParams): Promise<MemberProfileResponse> {
    return this.client.get<MemberProfileResponse>("https://members-ng.iracing.com/data/member/profile", { params, schema: MemberProfileSchema });
  }
