...
export class MemberService {
  ...
  async awards(params?: MemberAwardsParams): Promise<MemberAwardsResponse> {
    return this.client.get<MemberAwardsResponse>(
      'https://members-ng.iracing.com/data/member/awards',
      { params, paramsValidator: awardsParams, schema: MemberAwards },
    );
  }
  ...
  async awardInstances(params: MemberAwardInstancesParams): Promise<MemberAwardInstancesResponse> {
    return this.client.get<MemberAwardInstancesResponse>(
      'https://members-ng.iracing.com/data/member/award_instances',
      { params, paramsValidator: awardInstancesParams, schema: MemberAwardInstances },
    );
  }
  ...
  async chartData(params: MemberChartDataParams): Promise<MemberChartDataResponse> {
    return this.client.get<MemberChartDataResponse>(
      'https://members-ng.iracing.com/data/member/chart_data',
      { params, paramsValidator: chartDataParams, schema: MemberChartData },
    );
  }
  ...
  async get(params: MemberGetParams): Promise<MemberGetResponse> {
    return this.client.get<MemberGetResponse>('https://members-ng.iracing.com/data/member/get', {
      params,
  ...
  async participationCredits(): Promise<MemberParticipationCreditsResponse> {
    return this.client.get<MemberParticipationCreditsResponse>(
      'https://members-ng.iracing.com/data/member/participation_credits',
      { schema: MemberParticipationCredits },
    );
  }
  ...
  async profile(params?: MemberProfileParams): Promise<MemberProfileResponse> {
    return this.client.get<MemberProfileResponse>(
      'https://members-ng.iracing.com/data/member/profile',
      { params, paramsValidator: profileParams, schema: MemberProfile },
    );
  }
}
