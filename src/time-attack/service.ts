...
import type {
  TimeAttackMemberSeasonResultsParams,
...
export class TimeAttackService {
   ...
   */
  async memberSeasonResults(
    params: TimeAttackMemberSeasonResultsParams,
  ): Promise<TimeAttackMemberSeasonResultsResponse> {
    return this.client.get<TimeAttackMemberSeasonResultsResponse>(
      'https://members-ng.iracing.com/data/time_attack/member_season_results',
      { params, paramsValidator: memberSeasonResultsParams, schema: TimeAttackMemberSeasonResults },
    );
  }
}
