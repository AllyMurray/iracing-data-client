...
export class SeasonService {
   ...
   */
  async race_guide(params: SeasonRaceGuideParams): Promise<SeasonRaceGuideResponse> {
   ...
   */
  async spectator_subsessionids(params: SeasonSpectatorSubsessionidsParams): Promise<SeasonSpectatorSubsessionidsResponse> {
   ...
   */
  async spectator_subsessionids_detail(params: SeasonSpectatorSubsessionidsDetailParams): Promise<SeasonSpectatorSubsessionidsDetailResponse> {
