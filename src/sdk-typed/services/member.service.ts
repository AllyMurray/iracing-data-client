...
export class MemberService {
   ...
   */
  async award_instances(params: MemberAwardInstancesParams): Promise<MemberAwardInstancesResponse> {
   ...
   */
  async chart_data(params: MemberChartDataParams): Promise<MemberChartDataResponse> {
   ...
   */
  async participation_credits(): Promise<MemberParticipationCreditsResponse> {
