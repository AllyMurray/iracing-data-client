...
export class SeasonService {
  ...
  async list(params: SeasonListParams): Promise<SeasonListResponse> {
    return this.client.get<SeasonListResponse>('https://members-ng.iracing.com/data/season/list', {
      params,
      paramsValidator: listParams,
      schema: SeasonList,
    });
  }
  ...
  async raceGuide(params?: SeasonRaceGuideParams): Promise<SeasonRaceGuideResponse> {
    return this.client.get<SeasonRaceGuideResponse>(
      'https://members-ng.iracing.com/data/season/race_guide',
      { params, paramsValidator: raceGuideParams, schema: SeasonRaceGuide },
    );
  }
   ...
   */
  async spectatorSubsessionids(
    params?: SeasonSpectatorSubsessionidsParams,
  ): Promise<SeasonSpectatorSubsessionidsResponse> {
    return this.client.get<SeasonSpectatorSubsessionidsResponse>(
      'https://members-ng.iracing.com/data/season/spectator_subsessionids',
      {
        params,
        paramsValidator: spectatorSubsessionidsParams,
        schema: SeasonSpectatorSubsessionids,
      },
    );
  }
   ...
   */
  async spectatorSubsessionidsDetail(
    params?: SeasonSpectatorSubsessionidsDetailParams,
  ): Promise<SeasonSpectatorSubsessionidsDetailResponse> {
    return this.client.get<SeasonSpectatorSubsessionidsDetailResponse>(
      'https://members-ng.iracing.com/data/season/spectator_subsessionids_detail',
      {
        params,
        paramsValidator: spectatorSubsessionidsDetailParams,
        schema: SeasonSpectatorSubsessionidsDetail,
      },
    );
  }
}
