...
<Aside type="note">
  Built-in rate limit handling (automatic retry with backoff, request queuing, concurrency control) is planned for a future release. See our [roadmap](/iracing-data-client/roadmap/) for details. In the meantime, this guide covers strategies you can implement yourself.
</Aside>
