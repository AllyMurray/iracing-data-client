---
title: Caching
description: Understanding and optimizing the SDK's caching mechanisms
---
...
```typescript
async function preloadCache(iracing: IRacingSDK) {
...
<CardGrid>
  <Card title="✅ Trust SDK Caching">
    Let the SDK handle caching for most use cases - it's optimized for the API
  </Card>
