...
<Aside type="note">
  Built-in response caching is planned for a future release. When implemented, the SDK will automatically cache responses based on API expiration headers. See our [roadmap](/roadmap) for details. In the meantime, this guide covers strategies you can implement yourself.
</Aside>
...
- Review [Error Handling](/guides/error-handling/) for handling API errors
