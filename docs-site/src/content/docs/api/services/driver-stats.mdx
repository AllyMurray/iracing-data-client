...
<Aside type="note">
  These endpoints return data for the authenticated user. Use the [Stats Service](/api/services/stats/) for statistics about other members.
</Aside>

## See Also

- [Stats Service](/api/services/stats/) - General statistics and standings
