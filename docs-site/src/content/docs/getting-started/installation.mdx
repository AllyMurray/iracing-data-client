...
- **Node.js 22 or 24** or a modern browser environment with fetch support
...
Node.js 22 and 24 are supported and tested with both ESM and CommonJS. These
versions provide native fetch and Web Crypto support:
...
Node.js 18 and 20 are no longer supported. Upgrade to Node.js 22 or 24; adding a
