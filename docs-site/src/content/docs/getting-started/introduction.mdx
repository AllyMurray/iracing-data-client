...
<CardGrid>
  ...
  <Card title="⚡ Performance" icon="rocket">
    S3 link following, intelligent error handling, and opt-in response caching for optimal performance.
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <Card title="Response Caching">
    Can cache responses through pluggable stores using API-provided expiration headers
  </Card>
</CardGrid>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-top: 1rem;">
  ...
  <Card title="Smart Caching" icon="rocket">
    Optional response caching with automatic expiration
  </Card>
