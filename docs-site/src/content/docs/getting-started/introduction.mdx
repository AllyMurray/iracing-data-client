...
<CardGrid>
  ...
  <Card title="🔐 OAuth2 Auth" icon="key">
    Handles iRacing's OAuth2 authentication automatically with token management and automatic refresh.
  </Card>
  <Card title="⚡ Performance" icon="rocket">
    S3 link following, intelligent error handling, and pluggable response caching for optimal performance.
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <Card title="Response Caching">
    Intelligently caches responses based on API-provided expiration headers via pluggable stores
  </Card>
</CardGrid>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-top: 1rem;">
  ...
  <Card title="Smart Caching" icon="rocket">
    Response caching with automatic expiration via pluggable stores
  </Card>
...
<CardGrid>
  <Card title="Installation" icon="download">
    ...
    [Continue to Installation →](/iracing-data-client/getting-started/installation/)
  </Card>
  <Card title="Quick Start" icon="rocket">
    See a complete working example
    
    [View Quick Start →](/iracing-data-client/getting-started/quick-start/)
  </Card>
</CardGrid>
